...
export default function PhoneFrame({
  ...
  return (
    <div
      className={`relative mx-auto aspect-[9/19.5] h-[min(68vh,660px)] w-auto max-w-[82vw] rounded-[44px] border-[3px] border-white/15 bg-neutral-950 p-2.5 shadow-[0_40px_120px_-30px_rgba(139,92,246,0.45)] ${className}`}
    >
